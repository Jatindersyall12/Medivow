...
/**
 * Created by emp236 on 6/17/2017.
 */
...
public class RotateImageUtil {
     ...
     */
    private static Bitmap rotateImageIfRequired(Context mContext, Bitmap img, Uri selectedImage) throws IOException {
    ...
    /**
     * This method return bitmap after rortating it by specified angle
     *
     * @param bitmap
     * @param angle
     * @return
