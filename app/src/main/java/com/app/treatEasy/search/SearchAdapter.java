...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder>{
    ...
    private List<SearchDoctorRes.Datum> mModelList = new ArrayList<>();

    public SearchAdapter(Context context, ItemClickListener itemClickListener,List<SearchDoctorRes.Datum> mModelList){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.txt_hospital.setText(mModelList.get(position).getDisplayName());
